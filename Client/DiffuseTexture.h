...
{
public:
	DiffuseTexture(const std::string& path, TextureFilterType filterType, TextureWrapType wrapType, bool genMipMaps = true);
...
private:
	...
	static std::vector<GLuint> diffuseTextureUniforms;
};